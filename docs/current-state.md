...
Phase R80 — heuristic scan complete. Phase transition in progress: `Phase R81 heuristic gap scan` is the active task.
...
The current next action is: `Phase R81 heuristic gap scan`
