...
Phase R77 — heuristic scan complete. Phase transition in progress: `Phase R78 heuristic gap scan` is the active task.
...
The current next action is: `Phase R78 heuristic gap scan`
