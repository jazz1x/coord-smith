...
ENV_SESSION_REF = "EZAX_SESSION_REF"
ENV_EXPECTED_AUTH_STATE = "EZAX_EXPECTED_AUTH_STATE"
ENV_TARGET_PAGE_URL = "EZAX_TARGET_PAGE_URL"
ENV_SITE_IDENTITY = "EZAX_SITE_IDENTITY"
